...
public class Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton11.setText("Thống Kê Dữ Liệu");
        ...
        jButton15.setText("Thống Kê Doanh Thu");
        ...
        jLabel99.setText("Thống Kê Doanh Thu");
        ...
        jLabel100.setText("Loại thời gian");
        ...
        label1.setText(" Ngày bắt đầu");
        jPanel28.add(label1, new org.netbeans.lib.awtextra.AbsoluteConstraints(51, 147, 130, -1));

        ky_TK.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "HK1", "HK2", "HK3", "Cả Năm" }));
        ...
        jLabel107.setText("Tổng Doanh Thu");
        ...
        loaiCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Báo cáo theo ngày", "Báo cáo theo tháng", "Báo cáo theo học kỳ" }));
...
//            }
    ...
    private void loaiComboActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loaiComboActionPerformed
        ...
        if(loaiCombo.getSelectedIndex()==0){
            ...
            label1.setText("Tháng bắt đầu");
            label2.setText("Tháng kết thúc");
        }else{
        ...
        if(loaiCombo.getSelectedIndex()==0){
            ...
            if(monthBD==monthKT&&yearBD==yearKT){
                ...
                showTK_Ngay();
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Vui lòng chỉ chọn ngày kết thúc lớn hơn ngày bắt đầu");
            }
            else JOptionPane.showMessageDialog(rootPane, "Vui lòng chỉ chọn ngày cùng tháng");
        }else if(loaiCombo.getSelectedIndex()==1){
            Date dateBD=ngayBD_TK.getDate();
            Date dateKT=ngayKT_TK.getDate();
            int monthBD=month(dateBD);
            ...
            if(yearBD==yearKT){
                ...
                showTK_Thang();
                    ...
                    JOptionPane.showMessageDialog(rootPane, "Vui lòng chỉ chọn tháng kết thúc lớn hơn tháng bắt đầu");
            }
            else{
                JOptionPane.showMessageDialog(rootPane, "Vui lòng chỉ chọn tháng cùng năm");
            }
        }
...
void showTK_Ngay(){
    ...
    int tongDoanhThu=0;
     while(i<=dayKT){
         ...
         df.addValue(tien,"","Ngày "+i);
         tien=0;
         j=pos;
         i++;
    }
    JFreeChart chart=ChartFactory.createBarChart3D("Thống kê doanh thu theo ngày", "Ngày", "Tiền", df,PlotOrientation.VERTICAL,true,true,true);
...
void showTK_Thang(){
    ...
    while(i<=monthKT){
        ...
        df.addValue(tien,"","Tháng "+i);
         tien=0;
         j=pos;
         i++;
    }
    JFreeChart chart=ChartFactory.createBarChart3D("Thống kê doanh thu theo tháng", "Tháng", "Tiền", df,PlotOrientation.VERTICAL,true,true,true);
        CategoryPlot plot=chart.getCategoryPlot();
        plot.setRangeGridlinePaint(Color.BLACK);
        ChartPanel chartPanel=new ChartPanel(chart);
        panel.removeAll();
